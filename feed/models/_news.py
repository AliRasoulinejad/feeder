...
class News(models.Model):
    ...
    read_by = models.ManyToManyField(
        "user.User", related_name="reads_news", through="feed.UserReadNews"
    )
    favorite_by = models.ManyToManyField(
        "user.User", related_name="favorites", through="feed.UserFavoriteNews"
    )

    bookmarked_by = models.ManyToManyField(
        "user.User", related_name="bookmarks", through="feed.UserBookmarkNews"
    )
...
class UserReadNews(models.Model):
    user = models.ForeignKey(
        "user.User", on_delete=models.CASCADE, related_name="read_news"
    )
    news = models.ForeignKey(
        "feed.News", on_delete=models.CASCADE, related_name="users_read"
    )
...
class UserFavoriteNews(models.Model):
    user = models.ForeignKey(
        "user.User", on_delete=models.CASCADE, related_name="favorites_news"
    )
    news = models.ForeignKey(
        "feed.News", on_delete=models.CASCADE, related_name="users_favorite"
    )
...
class UserBookmarkNews(models.Model):
    user = models.ForeignKey(
        "user.User", on_delete=models.CASCADE, related_name="bookmarked_news"
    )
    news = models.ForeignKey(
        "feed.News", on_delete=models.CASCADE, related_name="users_bookmark"
    )
